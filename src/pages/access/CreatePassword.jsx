...
const CreatePassword = () => {
  ...
  const { isLoading, data: key } = useQueryData(
    `${apiVersion}/controllers/developers/settings/users/systems/key.php?key=${paramKey}`, // endpoint
    "get", // method
  ...
  const mutation = useMutation({
    mutationFn: (values) =>
      queryData(
        `${apiVersion}/controllers/developers/settings/users/systems/set-password.php`,
        "post",
        values,
      ),
    onSuccess: (data) => {
