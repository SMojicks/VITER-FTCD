...
const RolesList = ({ setItemEdit, itemEdit }) => {
  ...
  return (
    <>
      ...
      {store.isArchive && (
        <ModalArchive
          mysqlApiArchive={`${apiVersion}/controllers/developers/settings/users/roles/active.php?id=${itemEdit.role_aid}`}
          dataItem={itemEdit}
          queryKey="roles"
      ...
      {store.isRestore && (
        <ModalRestore
          mysqlApiRestore={`${apiVersion}/controllers/developers/settings/users/roles/active.php?id=${itemEdit.role_aid}`}
          dataItem={itemEdit}
          queryKey="roles"
      ...
      {store.isDelete && (
        <ModalDelete
          mysqlApiDelete={`${apiVersion}/controllers/developers/settings/users/roles/roles.php?id=${itemEdit.role_aid}`}
          dataItem={itemEdit}
          queryKey="roles"
