  ...
  return (
    <>
      <button
        ...
        className="px-4 py-2 flex items-center gap-2 hover:bg-gray-50/10 w-full uppercase justify-between"
      >
          ...
          {subNavList.map((item, key) => {
            return (
              <li key={key} className="w-full">
                <Link
                  to={item.path}
                  className="w-full pl-10 py-1 block hover:bg-gray-50/10 capitalize"
                >
                  {item.label}
                </Link>
              </li>
